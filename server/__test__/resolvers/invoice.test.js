...
describe("Invoice",  () => { 
  ...
  it('should fail with validation errors for each required field', async () => {
    ...
    const { data: { createInvoice: { success } } } = response.data
  ...
  it('createInvoice', async () => {   
    ...
    const { data: { createInvoice: { success, invoice } } }  = response.data
  ...
  it('updateInvoice', async () => { 
    ...
    const { data: { updateInvoice: { success, invoice } } } = response.data
  ...
  it('deleteInvoice', async () => { 
    ...
    const { data: { deleteInvoice: { success } } } = response.data
