...
export default {
  ...
  Mutation: {
    createTask: requiresAuth.createResolver(
      (parent, args, { models, subdomain }) =>
    ...
    updateTask: requiresAuth.createResolver(
      (parent, args, { models, subdomain }) =>
    ...
    deleteTask: requiresAuth.createResolver(
      (parent, args, { models, subdomain }) =>
        models.Task.destroy({
          where: { id: args.id },
          force: true,
