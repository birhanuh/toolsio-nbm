describe("Customers", function() {
  ...
  it("Create invoice", function() {
    ...
    // should contain Project 1
    cy.get("table:nth-child(2) tr:first-child td:nth-child(2)").should(
      "contain",
      "Project 1"
    );
  ...
  it("Update invoice", function() {
    cy.get(
      "table tr:first-child td:last-child .ui.buttons > a:first-child"
    ).click();
    ...
    cy.get("table tr:first-child td:nth-child(5) div").should(
      "contain",
      "pending"
    );
  });
  ...
  it("Delete invoice", function() {
    cy.get(
      "table tr:first-child td:last-child .ui.buttons > a:last-child"
    ).click();
