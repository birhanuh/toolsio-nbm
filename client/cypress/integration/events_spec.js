describe('Customers', function() {
  ...
  it('Create event', function() {
    cy.get('.fc-widget-content .fc-row:nth-child(5) .fc-bg table tr .fc-widget-content.fc-future:nth-child(2)').click()

    cy.get('.ui.form input[name=title]').type('Event 1')
    cy.get('.ui.form input[name=url]').type('http://example.com')
    cy.get('.ui.form textarea[name=description]').type('Event 1 description...')
    ...
    cy.get('.fc-widget-content .fc-row:nth-child(5) .fc-content-skeleton table tr td.fc-event-container .fc-content span:nth-child(2)').should('contain', 'Event 1')
  })

  it('Edit event', function() {
    cy.get('.fc-widget-content .fc-row:nth-child(5) .fc-content-skeleton table tr td.fc-event-container a').click()
    ...
    // should contain Customera
    cy.get('.fc-widget-content .fc-row:nth-child(5) .fc-content-skeleton table tr td.fc-event-container .fc-content span:nth-child(2)').should('contain', 'Event 1 updated')
  })
  ...
  xit('Delete event', function() {
    ...
    cy.get('.ui.message p]').should('contain', 'Your account is now deleted. Sorry to not see you again!')
  })
})
