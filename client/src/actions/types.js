...
export const SET_PROJECSTS = 'SET_PROJECSTS'
export const SET_SALES = 'SET_SALES'
export const SET_INVOICES = 'SET_INVOICES'
export const SET_CUSTOERMS = 'SET_CUSTOERMS'
export const SET_PROJECT_TASKS = 'SET_PROJECT_TASKS'
export const SET_SALE_TASKS = 'SET_SALE_TASKS'
export const SET_INVOICE_TASKS = 'SET_INVOICE_TASKS'
