    ...
    <Grid.Row>
      <Grid.Column width={4}>
        <Menu vertical fluid className="conversations-sidebar">
          ...
          <Divider horizontal className="pt-2 mb-0">
            Or
          </Divider>
          ...
          <Switch>
            <Route
              ...
              render={() => (
                <div>
                  <Header as="h3">
                    {T.translate(`conversations.page.landing_header`)}
                  </Header>
                  <List>
                    <List.Item>
                      ...
                      <List.Content>
                        <p>
                          {T.translate(
                            `conversations.page.landing_colleagues_description`
                          )}
                        </p>
                      </List.Content>
                    </List.Item>
                    <List.Item>
                      ...
                      <List.Content>
                        <p>
                          {T.translate(
                            `conversations.page.landing_messages_description`
                          )}
                        </p>
                      </List.Content>
                    </List.Item>
                    <List.Item>
                      ...
                      <List.Content>
                        <p>
                          {T.translate(
                            `conversations.page.landing_attachments_description`
                          )}
                        </p>
                      </List.Content>
                    </List.Item>
