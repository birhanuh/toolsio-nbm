...
class LandingPage extends PureComponent {
  ...
  isValid() {
    const { errors, isValid } = Validation.validateContactMessageInput(
      this.state
    );
      ...
      this.props
        ...
        .then(res => {
          ...
          if (success) {
            this.props.addFlashMessage({
              type: "success",
              text: T.translate(
                "landing.contacts.flash.success_create_contact_message"
              )
            });
            // Reset state
            this.setState({
        ...
        .catch(err => {
          this.props.addFlashMessage({
            type: "error",
            text: T.translate(
              "landing.contacts.flash.error_create_contact_message"
            )
          });
    ...
    return (
      <div onClick={this.hideSidebarVisibility}>
        <Segment
          ...
          vertical
          id="features"
          className="stripe background-white"
        >
          <Grid container stackable verticalAlign="middle">
            <Grid columns={2} centered>
              <Header as="h2" aligned="center">
                {T.translate("landing.features.header")}
              </Header>

              <Grid.Column>
                <div className="sprite invoice left floated" />
                <blockquote>
                  <h3 className="ui header">
                    {T.translate("landing.features.invoice.header")}
                  </h3>
                  <p>{T.translate("landing.features.invoice.text")}</p>
                </blockquote>
              </Grid.Column>
              <Grid.Column>
                <div className="sprite sale left floated" />
                <blockquote>
                  <h3 className="ui header">
                    {T.translate("landing.features.sale.header")}
                  </h3>
                  <p>{T.translate("landing.features.sale.text")}</p>
                </blockquote>
              </Grid.Column>
              <Grid.Column>
                <div className="sprite project left floated" />
                <blockquote>
                  <h3 className="ui header">
                    {T.translate("landing.features.project.header")}
                  </h3>
                  <p>{T.translate("landing.features.project.text")}</p>
                </blockquote>
              </Grid.Column>
              <Grid.Column>
                <div className="sprite analysis left floated" />
                <blockquote>
                  <h3 className="ui header">
                    {T.translate("landing.features.analysis.header")}
                  </h3>
        ...
        <Segment
          ...
          vertical
          id="clients"
          className="stripe background-xx-light-grey"
        >
          <Grid container stackable verticalAlign="middle">
            <Grid columns={2} centered>
              <Header as="h2" aligned="center">
              ...
              <Grid columns={3}>
                <Grid.Column>
                  <div className="company-logo">
                    <div className="sprite logo-one" />
                  </div>
                </Grid.Column>
                <Grid.Column>
                  <div className="company-logo">
                    <div className="sprite logo-two" />
                  </div>
                </Grid.Column>
                <Grid.Column>
                  <div className="company-logo">
                ...
                <div className="slides">
                  ...
                  <div className="slide-item item2 fade">
                    ...
                    <h5 className="ui header">
                      ...
                      at its layout. Simply dummy text of the printing and
            ...
            <Grid.Row columns={1} centered>
              ...
              <Grid columns={3} stackable>
                <Grid.Column>
                  <ul className="pricing-plan">
                    <li className="pricing-title">
                      {T.translate("landing.pricing.basic.title")}
                    </li>
                    <li className="pricing-desc">
                      {T.translate("landing.pricing.basic.description")}
                    </li>
                ...
                <Grid.Column>
                  <ul className="pricing-plan">
                    <li className="pricing-title">
                      {T.translate("landing.pricing.standard.title")}
                    </li>
                    <li className="pricing-desc">
                      {T.translate("landing.pricing.standard.description")}
                    </li>
                    <li className="pricing-price">$0</li>
                    <li>{T.translate("landing.pricing.standard.analytics")}</li>
                    <li>
                      {T.translate("landing.pricing.standard.invitation")}
                    </li>
                ...
                <Grid.Column>
                  <ul className="pricing-plan">
                    <li className="pricing-title">
                      {T.translate("landing.pricing.premium.title")}
                    </li>
                    <li className="pricing-desc">
                      {T.translate("landing.pricing.premium.description")}
                    </li>
                    <li className="pricing-price">$0</li>
              ...
              <Grid.Column>
                ...
                >
                  ...
                  <Form.Field error={!!errors.messageBody}>
                    <label>
                      {T.translate("landing.contacts.message_body")}
                    </label>
                    <TextArea
