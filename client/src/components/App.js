...
class App extends Component {
  ...
  toggleInnerSidebarVisibility = () =>
    this.setState(state => ({
      visibleInnerSidebar: !state.visibleInnerSidebar
    }));

  toggleOuterSidebarVisibility = () =>
    this.setState(state => ({
      visibleOuterSidebar: !state.visibleOuterSidebar
    }));
  ...
  render() {
    ...
    return [
      <Sidebar.Pushable key="Sidebar">
        {isAuthenticated() && !isAuthPages() && (
          <InnerSidebar
            ...
            key="InnerSidebar"
            visibleInnerSidebar={visibleInnerSidebar}
          />
        )}
        <Sidebar.Pusher onClick={this.hideSidebarVisibility}>
          ...
          {!isAuthenticated() && !isAuthPages() && (
            <LandingPageHeaderNav
              toggleOuterSidebarVisibility={this.toggleOuterSidebarVisibility}
            />
          )}
          ...
          >
            ...
            {/* Falsh messages */}
            {!isAuthPages() && <FlashMessage location={window.location.href} />}
                    ...
                    <Grid.Column>
                      ...
                      <div className="ui horizontal inverted small divided link list">
                        <a className="item" href="/terms-and-conditions">
                          {T.translate("landing.footer.terms_and_conditions")}
                        </a>
                        <a className="item" href="/privacy-policy">
                          {T.translate("landing.footer.privacy_policy")}
                        </a>
                      </div>
                    </Grid.Column>
                  </Grid.Row>
      ...
      <OuterSidebarScrollableHeader
        key="OuterSidebarScrollableHeader"
        visibleOuterSidebar={visibleOuterSidebar}
      />,
