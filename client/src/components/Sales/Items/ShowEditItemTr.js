...
export default function ShowEditItemTr({
  item,
  editItem,
  handleEdit,
  handleCancelEdit,
      ...
      <td className="edit-item">
        <Form.Field>
          <Select
            ...
            value={editItem.unit}
            onChange={(e, { value }) =>
              handleEditItemChange("unit", value, item)
            }
      ...
      <td className="edit-item">
        <Form.Field>
          <Input
            ...
            onChange={(e, { value }) =>
              handleEditItemChange("quantity", value, item)
            }
      ...
      <td className="edit-item">
        <Form.Field>
          <Input
            ...
            onChange={(e, { value }) =>
              handleEditItemChange("unitPrice", value, item)
            }
            onBlur={handleEditItemBlur}
