          ...
          .then(res => {
            ...
            if (success) {
              this.props.addFlashMessage({
                type: "success",
                text: T.translate("events.form.flash.success_update", {
                  title: event.title
                })
              });
        ...
        this.props
          ...
          .then(res => {
            ...
            if (success) {
              this.props.addFlashMessage({
                type: "success",
                text: T.translate("events.form.flash.success_create", {
                  title: event.title
                })
              });
  ...
  render() {
    ...
    return (
      ...
      >
        <Modal.Header>
          {id
            ? T.translate("events.form.edit_event")
            : T.translate("events.form.new_event")}
        </Modal.Header>
        <Modal.Content>
        ...
        <Modal.Actions>
          <button className="ui button" onClick={toggleConfirmationModal}>
            {T.translate("events.form.cancel")}
          </button>
          <button
            disabled={isLoading}
