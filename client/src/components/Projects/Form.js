  ...
  constructor(props) {
    ...
    this.state = {
      ...
      deadline: this.props.data.getProject
        ? new Date(this.props.data.getProject.deadline)
        : new Date(),
      customerId: this.props.data.getProject
        ? this.props.data.getProject.customer.id
        : "",
    ...
    if (nextProps.data.getProject) {
      this.setState({
        ...
        description: !nextProps.data.getProject.description
          ? ""
          : nextProps.data.getProject.description
      });
    }
  };
        ...
        this.props
          ...
          .then(res => {
            ...
            if (success) {
              this.props.addFlashMessage({
                type: "success",
                text: T.translate("projects.form.flash.success_create", {
                  name: project.name
                })
              });
          ...
          <Segment>
            ...
            >
              <div className="inline field">
                {id ? (
                  <Header as="h1">
                    {T.translate("projects.form.edit_project")}
                  </Header>
                ) : (
                  <Header as="h1">
                    {T.translate("projects.form.new_project")}
                  </Header>
                )}
              </div>
              ...
              {customersOptions && customersOptions.length === 0 && (
                <div className="inline field">
                  <Message info size="small" className="mb-1">
                    <p>
                      {T.translate("projects.form.empty_customers_message")}
                    </p>
              ...
              <div className="inline field">
                ...
                <Button primary disabled={isLoading}>
                  ...
                  &nbsp;{T.translate("projects.form.save")}
                </Button>
              </div>
            </FormElement>
          </Segment>
