...
import { Segment, Input, Select, Form as FormElement, Button, Message } from 'semantic-ui-react'
    ...
    return (    
      <Segment>        
        <FormElement loading={isLoading} onSubmit={this.handleSubmit.bind(this)}>
            ...
            <Button primary fluid disabled={isLoading || invalid}>{T.translate("sign_up.sign_up")}</Button>
        </FormElement>  
      </Segment>
    )
  }
...
export default connect(null, { addFlashMessage } ) (graphql(REGISTER_USER_MUTATION)(Form))
