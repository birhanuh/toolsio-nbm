      ...
      this.setState({
        ...
        address: {
          street: nextProps.data.getCustomer.street
            ? nextProps.data.getCustomer.street
            : "",
          postalCode: nextProps.data.getCustomer.postalCode
            ? nextProps.data.getCustomer.postalCode
            : "",
          region: nextProps.data.getCustomer.region
            ? nextProps.data.getCustomer.region
            : "",
          country: nextProps.data.getCustomer.country
            ? nextProps.data.getCustomer.country
            : ""
        },
        ...
        contact: {
          phoneNumber: nextProps.data.getCustomer.phoneNumber
            ? nextProps.data.getCustomer.phoneNumber
            : "",
          email: nextProps.data.getCustomer.email
            ? nextProps.data.getCustomer.email
            : ""
        }
      });
    }
      ...
      if (id) {
          ...
          .then(res => {
            ...
            if (success) {
              this.props.addFlashMessage({
                type: "success",
                text: T.translate("customers.form.flash.success_update", {
                  name: name
                })
              });
        ...
        this.props
          ...
          .then(res => {
            ...
            const value = window.performance.getEntriesByName(
              "form_interaction"
            )[0].duration;
            ...
            if (success) {
              this.props.addFlashMessage({
                type: "success",
                text: T.translate("customers.form.flash.success_create", {
                  name: name
                })
              });
          ...
          <Segment>
            ...
            >
              <div className="inline field">
                {id ? (
                  <Header as="h1">
                    {T.translate("customers.form.edit_customer")}
                  </Header>
                ) : (
                  <Header as="h1">
                    {T.translate("customers.form.new_customer")}
                  </Header>
                )}
              </div>
                ...
                <FormElement.Field inline error={!!errors.phoneNumber}>
                  ...
                  <Input
                    placeholder={T.translate(
                      "customers.form.contact.phone_number"
                    )}
                    name="phoneNumber"
              ...
              <FormElement.Field inline>
                <label>
                  {T.translate("customers.form.include_contact_in_invoice")}
                </label>
                <Checkbox
                  toggle
              ...
              <fieldset className="custom-fieldset">
                ...
                >
                  ...
                  <Input
                    placeholder={T.translate(
                      "customers.form.address.postal_code"
                    )}
                    name="postalCode"
                ...
                >
                  ...
                  <CountryDropdown
                    defaultOptionLabel={T.translate(
                      "customers.form.address.select_country"
                    )}
              ...
              <div className="inline field">
                ...
                <Button primary disabled={isLoading}>
                  ...
                  &nbsp;{T.translate("customers.form.save")}
                </Button>
              </div>
            </FormElement>
          </Segment>
