  ...
  return (
    <Form loading={isLoading}>
      ...
      <div className="inline field">
        {id ? (
          <Header as="h1">{T.translate("invoices.form.edit_invoice")}</Header>
        ) : (
          <Header as="h1">
            {T.translate("invoices.form.new_invoice")}
            <Header.Subheader className="d-inline-block pl-1">
              {T.translate("invoices.form.confirmation")}
            </Header.Subheader>
          </Header>
        )}
      </div>
          ...
          <tbody>
            ...
            <tr>
              <td>
                <i>
                  <Header size="tiny">
                    {T.translate("invoices.show.status")}
                  </Header>
                </i>
              </td>
              <td>
                <Label
                  ...
                  className={classnames("uppercase", {
                    blue: step2.status === "new" || step2.status === "",
                    orange: step2.status === "pending",
                    green: step2.status === "paid",
                    red: step2.status === "overdue"
                  })}
                >
                  {step2.status ? step2.status : "new"}
                </Label>
              </td>
            </tr>
            <tr>
              ...
              <td>{step2.paymentTerm ? step2.paymentTerm : "-"}</td>
            </tr>
            <tr>
              <td>
                <i>
              ...
              <td>{step2.interestInArrears}</td>
            </tr>
            <tr>
              <td>
                <i>
                  <Header size="tiny">
                    <strong>{T.translate("invoices.show.total")}</strong>
                  </Header>
                </i>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>{step2.description ? step2.description : "-"}</td>
            </tr>
          </tbody>
        </Table>
      </div>
            ...
            <tbody>
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.sale.name")}
                    </Header>
                  </i>
                </td>
                <td>{sale.name}</td>
              ...
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.sale.status")}
                    </Header>
                  </i>
                </td>
                <td>
                  <div
                    className={classnames("ui tiny uppercase label", {
              ...
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.sale.customer")}
                    </Header>
                  </i>
                </td>
                <td>{id ? step2.customer.name : sale.customer_name}</td>
              </tr>
            </tbody>
          </Table>
        </div>
            ...
            <tbody>
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.project.name")}
                    </Header>
                  </i>
                </td>
                <td>{project.name}</td>
              ...
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.project.status")}
                    </Header>
                  </i>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <i>
                    <Header size="tiny">
                      {T.translate("invoices.form.project.customer")}
                    </Header>
                  </i>
                </td>
                <td>{id ? step2.customer.name : project.customer_name}</td>
              </tr>
            </tbody>
          </Table>
        </div>
      ...
      <div className="inline field">
        <Button onClick={handlePrevious}>
          ...
          {T.translate("invoices.form.previous")}
        </Button>
        <Button primary disabled={isLoading} onClick={handleSubmit}>
          <Icon name="check circle outline" />
          &nbsp;{T.translate("invoices.form.save")}
        </Button>
