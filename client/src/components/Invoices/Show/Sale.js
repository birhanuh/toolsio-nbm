  ...
  return (
    <Card fluid>
      <Card.Content className="p-4">
        <Header as="h3">
          <Link to={`/sales/show/${sale.id}`}>{sale.name}</Link>
        </Header>
      </Card.Content>
      <Card.Content>
        <Table basic="very" collapsing celled>
          <tbody>
            <tr>
              <td>
                <i className="ui tiny header">
                  {T.translate("invoices.show.sale.deadline")}
                </i>
              </td>
            ...
            <tr>
              <td>
                <i className="ui tiny header">
                  {T.translate("invoices.show.sale.status")}
                </i>
              </td>
              <td>
                <Label
            ...
            <tr>
              <td>
                <i className="ui tiny header">
                  {T.translate("invoices.show.sale.description")}
                </i>
              </td>
              <td>{sale.description ? sale.description : ""}</td>
            </tr>
          </tbody>
        </Table>

        <Header as="h4">
          {T.translate("invoices.show.sale.items.header")}
        </Header>
          ...
          <thead>
            <tr>
              ...
              <th className="right aligned">
                {T.translate("invoices.show.sale.items.unit")}
              </th>
              <th className="right aligned">
                {T.translate("invoices.show.sale.items.quantity")}
              </th>
              <th className="right aligned">
                {T.translate("invoices.show.sale.items.unit_price")}
              </th>
              <th className="right aligned">
                {T.translate("invoices.show.sale.items.total")}
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td
                className={classnames("right aligned", {
                  ...
                  green:
                    sale.status === "finished" || sale.status === "delivered",
