...
class Page extends Component {
  ...
  printPDF = (referenceNumber, event) => {
    ...
    html2canvas(pdfElement, {logging: true, onclone: function(documentCloned) {
        // Hide unwanted elements
        documentCloned.querySelector('.btn-groups').style.display = 'none'
        documentCloned.querySelector('.pdf-download-btn').style.display = 'none'
      }})
      .then((canvas) => {
          ...
          <Segment>
            <div className="ui vertically divided grid">
              <Grid.Row className="pb-0">
                <Grid.Column width={7}>
                  <Header as='h1' className={classnames("uppercase", {blue: status === 'new', orange: status === 'pending', red: status === 'overdue', green: status === 'paid' })}>{T.translate("invoices.show.header")}
              ...
              <Grid.Row className={classnames("pt-0", {blue: status === 'new', orange: status === 'pending', red: status === 'overdue', green: status === 'paid' })}>
                <Grid.Column width={6}>
                  <Segment vertical>
                ...
                <Grid.Column width={4}>
                  <Segment vertical>
                    <Button basic className='pdf-download-btn' onClick={this.printPDF.bind(this, referenceNumber)}>
